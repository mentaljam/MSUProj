...
const char *msumr::MSUProj::version(VERSION_TYPE type) const
{
    ...
    {
    case VERSION_STRING:
        return MSUPROJ_VERSION_STRING;
    case VERSION_DATE:
        return MSUPROJ_VERSION_DATE;
    case VERSION_ARCH:
...
const msumr::RETURN_CODE msumr::MSUProj::warp(const bool &useUtm, const bool &zerosAsND)
{
    ...
    if (mDstFormat == "GTiff")
    {
        ...
        dstMetadata = CSLSetNameValue(dstMetadata, "TIFFTAG_SOFTWARE", "MSUProj v" MSUPROJ_VERSION_STRING);
